...
require get_template_directory().'/framework/hg-theme-framework/hg-theme-framework.php'; // New THEME FRAMEWORK FILE
require get_template_directory().'/framework/hg-framework/hg-framework.php'; // New FRAMEWORK FILE
require get_template_directory().'/framework/compatibility/config.php'; // compatibility config FILE
//</editor-fold desc=">>> CONSTANTS">
