...
<div class="iosSlider kl-slideshow-inner <?php echo $obj_parallax_class; ?>" <?php echo $main_obj_parallax_attribs; ?>>
	...
	<div class="kl-iosslider js-ios-slick" data-slick='<?php echo json_encode($slick_attributes) ?>'>
		...
		if ( isset ( $options['single_iosslider'] ) && is_array( $options['single_iosslider'] ) ) {
			...
			foreach ( $options['single_iosslider'] as $slide ) {
				...
				echo '<div class="item iosslider__item '.$bg_parallax_class.'" '.$slide_attr.'>';
				...
				if($slideType == 'image') {
					...
					echo WpkPageHelper::zn_klvideo($video_args);
